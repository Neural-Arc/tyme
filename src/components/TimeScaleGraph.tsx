...
export const TimeScaleGraph = ({
  ...
  return <div className="bg-black/40 border border-white/10 rounded-xl p-6 animate-fade-up">
      ...
      {bestTimeRange && defaultLocation && <div className="mb-6 p-4 bg-black/50 border border-blue-400/20 rounded-lg">
          <div className="flex justify-between items-start flex-wrap gap-2">
            <div className="flex-1 min-w-0">
              <p className="text-lg font-medium">
                <span className="font-bold text-cyan-400">Best meeting time:</span>
                <br />
            ...
            return <div key={cityData.city} className="card-animate space-y-1" style={{
              animationDelay: `${index * 0.1}s`
                  ...
                  <div className="flex justify-between items-center">
                    <div className="w-[160px]">
                      <span className={`text-sm truncate block ${isCurrentLocation ? 'text-white font-medium' : 'text-white/80'}`}>
                        {cityData.city}
                        {isCurrentLocation && <span className="ml-1 text-xs text-cyan-400">(Current)</span>}
                      </span>
                    ...
                    {bestTimeRange?.cityTimes[cityData.city] && <div className="absolute right-2 text-xs text-orange-400 font-medium">
                  ...
                  <div className="relative h-10 ml-[180px]">
                    ...
                    const isBestTimeHour = bestTimeRange && calculateTimeSlot(cityData.offset, bestTimeRange.utcHour) === hour;
